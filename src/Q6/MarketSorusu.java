...
public class MarketSorusu {
	...
	public static void main(String[] args) {
			 ...
			 * kazandığını gösteren bir method yazınız. 1. Adım : Günleri içeren bir tane
			 * ArrayList oluşturun. (gunler) 2. Adım : Günlük kazançları ekleyeceğimiz bir
			 * tane ArrayList oluşturun. (gunlukKazanclar) 3. Adım : While döngüsü ile
			 * kullanıcıdan 7 günlük kazançları tekek teker alıp gunlukKazanclar ArrayList'e
			 * ekle. 4. Adım : getOrtalamaKazanc() adlı method ile ortalama kazancı alın. 5.
			 * Adım : getOrtalamaninUstundeKazancGünleri() adlı method oluşturun. for
			 * döngüsü ile tüm günleri ortalama kazanç ile karşılaştır ortalama kazançtan
			 * yüksekse o günleri return yap. 6. Adım : getOrtalamaninAltindaKazancGünleri()
			 * adlı method oluşturun. for döngüsü ile tüm günleri ortalama kazanç ile
			 * karşılaştır ortalama kazançtan aşağıysa o günleri return yap.
			 */
